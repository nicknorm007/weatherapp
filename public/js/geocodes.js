...
const handleLookup = () => { 
  ...
  fetch("http://nicksoddsandends.com/custom/lookup?place="+place)
...
const handleGetForecast = () => {
  ...
  window.location.href = "http://nicksoddsandends.com/weather?forecastUrl="+url+"&city="+city
}
...
const handleGetSelectedState = () => {
  ...
  if(state !== "Select State"){
    window.location.href = "http://nicksoddsandends.com/alerts?state="+state+"&abbrev="+abbrev
  }
